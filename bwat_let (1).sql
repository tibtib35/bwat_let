...
(1, 'Un chef-d\'œuvre absolu', 'Je suis ressorti de la salle complètement abasourdi. Un film qui se mérite, à voir absolument plusieurs fois.', 5, '2025-01-21 12:00:00', 1, 1, 4),
(2, 'Trop complexe pour moi', 'Visuellement époustouflant mais je me suis perdu dans les niveaux de rêves. Difficile à suivre.', 3, '2025-01-22 09:30:00', 1, 1, 5),
(3, 'Nolan au sommet de son art', 'Une maîtrise technique et narrative sans faille. DiCaprio est excellent. La fin reste ouverte à l\'interprétation.', 5, '2025-01-23 14:00:00', 1, 1, 6),
(4, 'Touchant et drôle à la fois', 'L\'un des films français les plus touchants que j\'ai vus. Omar Sy est extraordinaire, naturel et attachant.', 5, '2025-01-26 10:00:00', 1, 2, 4),
(5, 'Un feel-good movie parfait', 'Je l\'ai regardé en famille, on a tous pleuré et ri. Une histoire vraie qui rend le film encore plus fort.', 5, '2025-01-27 16:00:00', 1, 2, 5),
(6, 'Émotion garantie', 'Difficile de rester insensible. La relation entre les deux personnages est d\'une justesse rare.', 4, '2025-01-28 11:00:00', 1, 2, 6),
(7, 'Un choc cinématographique', 'Bong Joon-ho nous prend par surprise à chaque tournant. Une œuvre magistrale qui méritait tous ses prix.', 5, '2025-02-06 11:00:00', 1, 3, 4),
(8, 'Bien mais un peu surestimé', 'Très bon film mais je ne comprends pas tout l\'engouement. La fin m\'a laissé perplexe.', 3, '2025-02-07 14:30:00', 1, 3, 6),
(9, 'Heath Ledger, une légende', 'La performance de Heath Ledger restera dans l\'histoire. Un Joker iconique pour un film iconique. Frissons garantis.', 5, '2025-02-16 09:00:00', 1, 4, 5),
(10, 'Le meilleur film de super-héros', 'Bien loin des blockbusters classiques, The Dark Knight est un vrai film de cinéma. Intelligent et intense.', 5, '2025-02-17 11:00:00', 1, 4, 6),
(11, 'Magistral', 'Nolan redéfinit le genre. On oublie qu\'on regarde un film de super-héros tellement c\'est prenant.', 5, '2025-02-18 15:00:00', 1, 4, 4),
(12, 'Émotionnellement dévastateur', 'La scène des messages vidéo m\'a arraché des larmes. Un film d\'une beauté et d\'une profondeur rares.', 5, '2025-03-02 10:00:00', 1, 5, 4),
(13, 'Un peu trop long', 'Des longueurs dans le dernier acte mais globalement un film impressionnant et ambitieux.', 3, '2025-03-03 15:00:00', 1, 5, 5),
(14, 'La France comme on l\'aime', 'Un film plein de poésie et de couleurs. On ressort avec le sourire. Jeunet est un vrai magicien de l\'image.', 5, '2025-03-11 09:00:00', 1, 6, 4),
(15, 'Un classique intemporel', 'Audrey Tautou est inoubliable dans ce rôle. Paris n\'a jamais été aussi beau et vivant.', 4, '2025-03-12 14:00:00', 1, 6, 6),
(16, 'Glaçant de bout en bout', 'Hopkins et Foster forment un duo inoubliable. Un thriller psychologique d\'exception qui ne vieillit pas.', 5, '2025-03-21 10:00:00', 1, 7, 5),
(17, 'Pas pour les âmes sensibles', 'Brillant mais vraiment angoissant. À ne pas regarder seul la nuit. Une maîtrise absolue du suspense.', 4, '2025-03-22 16:00:00', 1, 7, 6),
(18, 'Révolutionnaire', 'Tarantino a changé le cinéma à jamais avec ce film. Chaque scène est culte, chaque dialogue est ciselé.', 5, '2025-04-02 11:00:00', 1, 8, 4),
(19, 'Un film culte pleinement justifié', 'Les dialogues sont d\'une richesse incroyable. Une expérience unique que tout cinéphile se doit de vivre.', 5, '2025-04-03 14:00:00', 1, 8, 5);
...
(2, 'Intouchables', 'L\'amitié improbable entre Philippe, milliardaire tétraplégique, et Driss, son aide-soignant issu des banlieues.', '2011-11-02', 112, 'France', 'Français', 'img/affiche_intouchables.jpg', 3, 2, 2),
...
(1, 'Dupont', 'Alice', 'alice_d', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'alice.dupont@email.com', '12 bis rue des Lilas, Paris', '1995-03-15', '2025-01-10 09:00:00', '2025-05-01 14:22:00', 2),
...
(7, 'Marie', 'Axel', 'ax', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'axelmarie6@gmail.com', '251 avenue général Leclerc', '2007-04-06', '2026-05-25 18:10:03', '2026-05-25 18:10:03', 3);
